    ...
    public function up(): void
    {
        ...
        DB::table('provider_endpoints')->insert([
            [
                ...
                'meta' => json_encode([
                    'api_key_config' => 'majordom.providers.openrouter.api_key',
                    'base_url_config' => 'majordom.providers.openrouter.base_url',
                ]),
                'is_builtin' => true,
                'created_at' => $now,
                'updated_at' => $now,
            ...
            [
                ...
                'api_key' => null,
                'timeout' => config('majordom.providers.openrouter.timeout', 120),
                'meta' => json_encode(['base_url_config' => 'majordom.metallama.base_url']),
                'is_builtin' => true,
                'created_at' => $now,
                'updated_at' => $now,
            ],
